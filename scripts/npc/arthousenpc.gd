...
var dialogues = [
	{"name": "Ashley", "text": "Hi there! My name is Ashley."},
	{"name": "Ashley", "text": "Welcome to my House!"},
	{"name": "Ashley", "text": "Other people say its hard to look at but I call it art."},
	{"name": "Ashley", "text": "Its a beautiful design, Right?"},
	{"name": "Ashley", "text": "Anyways, I'm getting off track, I recently traveled to the future and encountered a lab."},
	{"name": "Ashley", "text": "But I accidently pressed some buttons I wasn't supposed to"},
	{"name": "Ashley", "text": "And some stuff came out of order. I really want to fix it but they won't let me come back."},
	{"name": "Ashley", "text": "Please, will you go and fix it? It's just like an art puzzle."}
]
...
func show_dialogue():
	...
	var sprite = dialogue_box.get_node_or_null("Sprite2D")
	if sprite:
		sprite.position = Vector2(500, 325)
	...
	if name_label:
		...
		name_label.position = Vector2(370, 285)
	...
	if text_label:
		...
		text_label.position = Vector2(370, 305)
...
func handle_choice_selection():
	...
	if selected_choice == 0:  # Yes
		print("[NPC] Player accepted quest! Loading PRISM ARRAY laser quest...")
		get_tree().change_scene_to_file("res://scenes/laser_quest.tscn")
	else:  # No
