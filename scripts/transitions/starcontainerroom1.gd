...
@export var spawn_position_in_mainhub: Vector2 = Vector2(168.4291, 43.49388)
@export var spawn_position_in_scr2: Vector2 = Vector2(312.9998, 48.333334)

var transition_cooldown: float = 1.0  # 1 second cooldown

func _ready():
	global.current_scene = "Starcontainerroom"
...
func change_scene():
	...
	if global.transition_scene2 == true and global.scene_transition_cooldown <= 0:
		print("Changing to Starcontainerroom2...")
		global.scene_transition_cooldown = transition_cooldown  # Start global cooldown
