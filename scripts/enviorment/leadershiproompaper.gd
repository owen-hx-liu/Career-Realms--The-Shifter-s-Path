...
var domain_name: String = "Leadership"  # Which domain this paper is for
...
func get_paper_content() -> Dictionary:
	...
	var pedestals_filled = global.get_total_pedestals_with_stars("Leadership")
	
	# Build the content
	var title = "👑 Leadership Department 👑"
	...
	content += "Leadership Stars: " + str(domain_stars)
	...
	content += "The Collapsing City Challenge\n\n"
	content += "The city is collapsing!\n"
	content += "Citizens need your leadership expertise to\n"
	content += "navigate the city and lead them out.\n\n"
	content += "Mission Objectives:\n"
	content += "• Find and guide all citizens\n"
	content += "• Avoid the sinkholes and spreading fires\n"
	content += "• Find your way to the city exit\n"
	content += "• Get as many citizens out as fast as possible!\n\n"
