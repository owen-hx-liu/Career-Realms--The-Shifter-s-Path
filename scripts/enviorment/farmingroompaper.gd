...
var domain_name: String = "Farming"  # Which domain this paper is for
...
func get_paper_content() -> Dictionary:
	...
	content += "Farming Stars: " + str(domain_stars)
	...
	content += "The Village Farming Challenge\n\n"
	content += "The village's food is low!\n"
	content += "Villagers need your farming expertise to\n"
	content += "plant produce and feed the village.\n\n"
	content += "Mission Objectives:\n"
	content += "• Plan and layout farm designs\n"
	content += "• Plant and grow crops\n"
	content += "• Strategically place crops to earn bonuses\n"
	content += "• Accrue the most amount of points in 30 minutes\n\n"
