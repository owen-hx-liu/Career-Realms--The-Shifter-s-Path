...
var domain_name: String = "Medicine"  # Which domain this paper is for
...
func get_paper_content() -> Dictionary:
	...
	content += "Medicine Stars: " + str(domain_stars)
	...
	content += "The Potion Hunting Challenge\n\n"
	content += "The villagers are sick!\n"
	content += "Villagers need your medicine expertise to\n"
	content += "diagnose patients and deliver cures.\n\n"
	content += "Mission Objectives:\n"
	content += "• Check cure ingredients and recipies\n"
	content += "• Explore and collect materials\n"
	content += "• Correctly craft and deilver cures\n"
	content += "• Get as many cures right as possible!\n\n"
