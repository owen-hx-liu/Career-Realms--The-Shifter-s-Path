...
@export var custom_font: Font  # Custom font for the paper text
var domain_name: String = "Art"  # Which domain this paper is for
...
func get_paper_content() -> Dictionary:
	...
	var pedestals_filled = global.get_total_pedestals_with_stars("Farming")
	
	# Build the content
	var title = "🎨 Art Department 🎨"
	...
	content += "Art Stars: " + str(domain_stars)
	...
	content += "The Laser Maze Challenge\n\n"
	content += "The lasers are all out of order!\n"
	content += "The art director needs your art expertise\n"
	content += "connect all of the lights with the right color.\n\n"
	content += "Mission Objectives:\n"
	content += "• Use the first laser to hit all lights\n"
	content += "• Use mirrors and color filters to manuever lasers\n"
	content += "• Get the correct color and orientation to move on\n"
	content += "• Complete all five levels!\n\n"
